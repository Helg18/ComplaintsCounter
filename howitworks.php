...
<div id="body">
	<div class= "article_section">
            <div class="page fine-print smallhead medium" id="terms" style="margin-bottom: 50px">
                    <h1>How <em>it</em> Works</h1>
                <h2>Here’s what we do: </h2>
                <p>1.	When a user sends us a complaint regarding a business, we send a confirmation to the email address of the user, to ensure the email address is real and there is a real person there. </p>
                <p>2.	We won't post a complaint where we don't receive verification of the sender’s email.</p>
