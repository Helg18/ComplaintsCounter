...
<body onload="loadMoreComplaints();" >
    ...
    <div id="body" style="width: 100%; float:left; padding: 0% 10% 0% 10%; text-align: center ">
	    ...
	    <div id="ajaxiconmorecomplaints" align="center" style="margin-top:-30px; margin-bottom:30px; margin-left:-10px;"></div>
        <div style="float:left; width: 100%; text-align: center " id="contentshowhidebutton" >
		
            <div id="showhidebutton" style="visibility:hidden; ">
              <p class="buttons" style = "text-align:center; margin-bottom:30px; margin-top:50px;" id="pinnextbuttonshowmore" >
