...
<div class = "main_header">
    ...
    ?>      
        ...
        <ul>
            <li><a href="#" onclick="showLogin('b'); return false;" class = "button-small">Business Register/Login</a></li>
        </ul>    
...
<?php 
  ...
  ?>
        <div class = "header_nav">
            <ul>
                <li><a class = "dropdown button-small"  href="userlog.php"><?php echo $dashboard ?></a></li>
            </ul>    
        </div>    
        
        <div class = "header_nav">
            <ul>
                <li class="dropdown button-small" style="margin-top:-7px;">
