            ...
            <div  id="payment" class="medium" >
              <form  role="form"  method="post" name="frmSubscription" id="frmSubscription" accept-charset="utf-8" style="text-align:left;" >
				...
				<div class="formsubscriber">
					...
					<div class = "controlform" >
                                            <select name="industrylist" id="industrylistregister" class="inputform inputaddbusiness " onclick="removeErrorMessageOnClick('spanIndustry')" >
...
function removeErrorMessageCity(){
    $('#spanTownRegister').attr("class", "");
    $('#spanTownRegister').html('');
}
