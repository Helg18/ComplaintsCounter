	...
	<div id="myModalB" class="modal fade">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
                        <form role="form" action = "javascript:addB();" id="frmAddBusiness">
				...
				<div class="formsubscriber">
					...
					<div class = "controlform-inline" >
                                            <select name="industrylist" id="industrylist" class="inputform inputaddbusiness inputregions" tabindex="31" onclick="removeErrorMessageOnClick('spanIndustry')" >
                                                <option value="">Select</option>
                                            </select>
                                            <div class = "messagesform"><span id = "spanIndustry"></span></div>
				    </div>
				</div>                                
				...
				<div class="formsubscriber">
					...
					<div class = "controlform-inline" >
				         ...
				         <div class = "messagesform"><span id = "spanAddress"></span></div>
				    </div>
				</div>  
				...
				<div class="formsubscriber">
					...
					<div class = "controlform-inline" >
                                            <select name="townlist" id="townlist" class="inputform inputaddbusiness inputregions" tabindex="33">
                                                <option value="">Select</option>
                                            </select>
				...
				<div class="formsubscriber">
					...
					<div class = "controlform-inline" >
                                            <select  name="countylist" id="countylist" class="inputform inputaddbusiness inputregions" tabindex="34">
                                                <option value="">Select</option>
                                            </select>
                                            <div class = "messagesform"></div>
				    </div>
				...
				<div class="formsubscriber">
					...
					<div class = "controlform-inline" >
                        ...
                        <div class="action_btns" style="text-align: center; padding-top: 10px;" >
                            <input type="submit"  class="btn btn-primary btn-default" name = "cmdAddBusiness" id = "cmdAddBusiness"  value ="Save" >
