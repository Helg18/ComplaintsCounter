 ...
 */
	public function ExplorerReviews($lastreview = 0, $orderby = 0, $viewed = 0, $starpoint = 0)
		{	
                    ...
                    $nocomplaints = "
                    <div align='center' style='width:100%; text-align:center; float:left; margin-bottom: 20px;'>
                                  <div class='well-small-no-complaint'>
                                    <div class='user-info'>
                                      <div class='user-review-picture'>
                                        <a href='index.php'>
                                          <img class='user-picture' src='img/shape.png' width='70px' height='auto'>
                                        </a>
                                      </div>
                                     </div>
                                    ...
                                    <div align='center'>
                                      <div>
                                        <div align='center' class='show-details-full-complaints'>
                                          <p class='name-business-review-avg' style='text-align:center; float: left; width:100%' id='BusinessComplainer'>At the moment there are no complaints.</p>
                                        </div>
                                      </div>
                                        <p align='center' class='linkclean' style='font-size: 16px; float: left; width:100%'><a style='font-size: 16px;' class='linkclean' href='index.php#who'>Register the first complaint here..!</a> </p>
                                    </div> 
                                  </div>
                                </div>";
			...
			$block ="
				<div class='well-sm-reviews'>
                                <div class = 'nocomplaintslogo' >
				".$showlogo."
                                </div>
	        <div class='review-info'>
	          <div align='center' class='show-details-full-complaints'>
	          <div class='name-business-review-avg nocomplainttitle' style='text-align:center; margin-top: -20px; padding-bottom: 10px; !important;' id='BusinessComplainer' >".$gotowebsite."</div>
	          <div style = 'width: 100% !important; float:left; text-align:center;padding-bottom: 10px;'><a href='".$viewcomplaints."'>".$row['totalcomplaints']." Complaints</a></div>
                    <form id='ratingsForm' style= 'margin: 0 !important;float:left; text-align:center;width: 100%; '>
                      <div class='stars-small-reviews'>
                        ".$star1checked."
                        <span></span>
                      </div> <!--end stars-small-reviews -->
	          ...
	          <div style='float:left;width: 100%; font-size:14px; font-weight: normal; text-align: center'>".$row['Address']." ".$row['Address2']."</div>
	          <div style='text-align:center; font-size:14px; font-weight: normal; margin-bottom:auto; '></div>
	          </div>
	        </div> <!--end review-info-->
      </div> <!--end review-->
				...
				$row['vieworderby'] = 0;
						...
						$row['block']     = $reviews;
						$row['numrows']   = $numrows;
                                                $row['nocomplaintsregistered']   = $nocomplaints;
